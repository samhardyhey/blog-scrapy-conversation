...
class TestTopics:
    ...
    def test_get_articles_by_topic(self, client: TestClient, clean_articles_index, sample_articles):
    ...
    def test_get_articles_by_topic_empty(self, client: TestClient, clean_articles_index):
    ...
    def test_get_articles_by_topic_with_pagination(self, client: TestClient, clean_articles_index, sample_articles):
    ...
    def test_get_popular_topics(self, client: TestClient, clean_articles_index, sample_articles):
    ...
    def test_get_popular_topics_with_limit(self, client: TestClient, clean_articles_index, sample_articles):
