...
class TestStats:
    ...
    def test_get_stats_with_data(self, client: TestClient, clean_articles_index, sample_articles):
    ...
    def test_author_stats(self, client: TestClient, clean_articles_index, sample_articles):
        ...
        for i in range(len(top_authors) - 1):
            assert top_authors[i]["article_count"] >= top_authors[i + 1]["article_count"]
    ...
    def test_department_stats(self, client: TestClient, clean_articles_index, sample_articles):
    ...
    def test_topic_stats(self, client: TestClient, clean_articles_index, sample_articles):
    ...
    def test_publication_timeline_stats(self, client: TestClient, clean_articles_index, sample_articles):
    ...
    def test_ingestion_timeline_stats(self, client: TestClient, clean_articles_index, sample_articles):
